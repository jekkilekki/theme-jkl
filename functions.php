...
function jkl_scripts() {
        ...
        // wp_enqueue_style( 'gfonts', 'https://fonts.googleapis.com/css?family=Montserrat:400,700|Source+Sans+Pro:400,400italic,300,300italic,700,700italic|Bree+Serif|Source+Code+Pro' );
	...
	wp_enqueue_script( 'jkl-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );
